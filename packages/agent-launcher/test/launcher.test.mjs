  ...
  artifacts: [
    {
      ...
      assetName: 'AdRouter-Agent-0.1.0-beta.11-darwin-universal.zip',
      assetUrl:
        'https://github.com/adrouter/adrouterAgent/releases/download/v0.1.0-beta.11/AdRouter-Agent-0.1.0-beta.11-darwin-universal.zip',
      sha256: 'a'.repeat(64),
    ...
    },
    {
      ...
      platform: 'linux',
      architectures: ['x64'],
      assetName: 'AdRouter-Agent-0.1.0-beta.11-linux-x64.zip',
      assetUrl:
        'https://github.com/adrouter/adrouterAgent/releases/download/v0.1.0-beta.11/AdRouter-Agent-0.1.0-beta.11-linux-x64.zip',
      sha256: 'b'.repeat(64),
    ...
    },
    {
      ...
      platform: 'win32',
      architectures: ['x64'],
      assetName: 'AdRouter-Agent-0.1.0-beta.11-win32-x64.zip',
      assetUrl:
        'https://github.com/adrouter/adrouterAgent/releases/download/v0.1.0-beta.11/AdRouter-Agent-0.1.0-beta.11-win32-x64.zip',
      sha256: 'c'.repeat(64),
      archiveRoot: '.',
...
test('validates the exact credential-free release manifest', () => {
  assert.equal(validateManifest(manifest).releaseVersion, '0.1.0-beta.11');
  const stableManifest = JSON.parse(JSON.stringify(manifest).replaceAll('0.1.0-beta.11', '0.1.0'));
